    ...
    static class APITestTask implements Runnable {
        ...
        public void run() {
            for (int i = 0; i < 200; i++) {
                ...
                String jsonPayload =  "{\"insertMany\": { \"documents\": [ { \"name\": \"Coded Cleats\", \"description\": \"ChatGPT integrated sneakers that talk to you\" }, { \"name\": \"Logic Layers\", \"description\": \"An AI quilt to help you sleep forever\" }, { \"name\": \"Logic Layers\", \"description\": \"An AI quilt to help you sleep forever\" }, { \"name\": \"Vision Vector Frame\", \"description\": \"Vision Vector Frame', 'A deep learning display that controls your mood\" } ] } }";
